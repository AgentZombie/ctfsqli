CREATE DATABASE ctf;
CREATE USER 'ctfrw'@'localhost' IDENTIFIED BY 'dDIESeNBAARaMapY0kc3Q';
GRANT ALL ON ctf.* to 'ctfrw'@'localhost';
CREATE USER 'ctfro'@'localhost' IDENTIFIED BY 'CB2fwpYY5c+KpT2FxzDmaA';
GRANT SELECT, SHOW VIEW ON ctf.* to 'ctfro'@'localhost';
FLUSH PRIVILEGES;
USE ctf;
CREATE TABLE users (
username text,
...
INSERT INTO users VALUES('nathan','traz0r5', '11/19/2007');
INSERT INTO users VALUES('lara','5urb1@l', '5/5/2013');
INSERT INTO users VALUES('chris','valN+!n3', '6/14/2013');
...
INSERT INTO expenses VALUES('8/6/20','lara','Deedee''s PPE',76);
...
INSERT INTO expenses VALUES('8/4/2020','nathan','Deedee''s PPE',454.17000000000001592);
...
INSERT INTO expenses VALUES('7/15/20','lara','Starbucks',208.88999999999998636);
...
INSERT INTO expenses VALUES('7/6/2020','nathan','Rick Shaw''s Rickshaws',145.94999999999998863);
...
INSERT INTO expenses VALUES('5/2/20','chris','Deedee''s PPE',43.149999999999998578);
